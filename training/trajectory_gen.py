from astro import astro_calcs, utils, constants, coordinate_conversions, utils
import numpy as np
import random
import csv
...
def generate_dataset(output_path, _r_range, _v_range, tof_range, num_trajs):
    ...
    for i in range(num_trajs):
        ...
        cartesian_sol, orbital_elements = astro_calcs.calculate_orbit(_r_gen, _v_gen, tof)
...
if __name__ == "__main__":
    generate_dataset("../datasets/dataset.csv", [constants.RADIUS_EARTH + 100, 10 * 10 ** 3], [3 , 20], [10*60, 2*60*60], 1 * 10 ** 2)